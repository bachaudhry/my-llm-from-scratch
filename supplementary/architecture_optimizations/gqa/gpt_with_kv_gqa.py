...
class GroupedQueryAttention(nn.Module):
    ...
    def forward(self, x, use_cache=False):
        ...
        if use_cache:
            ...
            keys_base, values_base = self.cache_k, self, self.cache_v
        else:
        ...
        if use_cache:
            ...
            self.ptr_current_pos =0
        k_positions = torch.arange(num_tokens_Q, device=device, dtype=torch.long)
...
def main():
    ...
    start_context = "Please allow me to"
